...
const features = [
              ...
              { label: "Compliance Framework Design" },
    ...
    <div>
      <section className="page-hero relative">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1920&q=80" alt="Cybersecurity" fill className="object-cover opacity-15" />
        ...
        <div className="relative z-container" style={{ maxWidth: "900px" }}>
          <ScrollReveal>
            ...
            <h1 style={{ fontSize: "clamp(2.75rem, 5vw, 4.5rem)" }} className="text-zeus-white mb-6">Cybersecurity</h1>
            <p className="section-subtitle" style={{ fontSize: "1.15rem" }}>Security assessments, compliance, and threat protection</p>
          </ScrollReveal>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <ScrollReveal delay={0.2}>
              <div className="relative rounded-2xl overflow-hidden border border-zeus-gold/10 h-full min-h-[400px]">
                <Image src="https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1920&q=80" alt="Cybersecurity" fill className="object-cover" />
