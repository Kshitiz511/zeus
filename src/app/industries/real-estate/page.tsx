    ...
    <div>
      <section className="page-hero relative">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1920&q=80" alt="Real Estate" fill className="object-cover opacity-15" />
        ...
        <div className="relative z-container" style={{ maxWidth: "900px" }}>
          <ScrollReveal>
            ...
            <h1 style={{ fontSize: "clamp(2.75rem, 5vw, 4.5rem)" }} className="text-zeus-white mb-6">Real Estate</h1>
            <p className="section-subtitle" style={{ fontSize: "1.15rem" }}>Market analysis, portfolio strategy, and digital transformation for real estate professionals.</p>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section style={{ paddingBlock: "var(--space-section)" }}>
        <div className="z-container">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal>
              <h2 className="section-title mb-6">How We Help <span className="text-zeus-gold">Real Estate</span></h2>
              <p className="text-zeus-text-secondary leading-relaxed mb-8" style={{ fontSize: "1.1rem" }}>
                Our team of specialists brings deep industry knowledge combined with cross-sector expertise to deliver transformative strategies tailored to the unique challenges of real estate.
              </p>
            ...
            <ScrollReveal delay={0.2}>
              <div className="relative rounded-2xl overflow-hidden border border-zeus-gold/10 h-[500px]">
                <Image src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1920&q=80" alt="Real Estate" fill className="object-cover" />
          ...
          <div className="text-center mt-20">
            <ScrollReveal>
              <h3 className="text-2xl text-zeus-white mb-6">Ready to transform your real estate business?</h3>
