...
const features = [
              ...
              { label: "Team Building Workshops" },
              { label: "Industry-Specific Cohorts" },
    ...
    <div>
      <section className="page-hero relative">
        <div className="absolute inset-0">
          <Image src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=1920&q=80" alt="Training & Development" fill className="object-cover opacity-15" />
        ...
        <div className="relative z-container" style={{ maxWidth: "900px" }}>
          <ScrollReveal>
            ...
            <h1 style={{ fontSize: "clamp(2.75rem, 5vw, 4.5rem)" }} className="text-zeus-white mb-6">Training & Development</h1>
            <p className="section-subtitle" style={{ fontSize: "1.15rem" }}>Expert-led cohort programs that promote collaboration, skill development, and industry-specific learning.</p>
          </ScrollReveal>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <ScrollReveal delay={0.2}>
              <div className="relative rounded-2xl overflow-hidden border border-zeus-gold/10 h-full min-h-[400px]">
                <Image src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=1920&q=80" alt="Training & Development" fill className="object-cover" />
